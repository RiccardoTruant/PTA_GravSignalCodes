...
C
C***ROUTINES CALLED  ZAIRY,ZUCHK,ZUNHJ,ZUOIK,D1MACH,ZABS1
...
C-----------------------------------------------------------------------
C-----------------------------------------------------------------------
        APHI = ZABS1(PHIR,PHII)
        AARG = ZABS1(ARGR,ARGI)
